...
void Camera::Update()
{
	...
	m_forward.x = sin((m_orientation.y) * 3.1415 / 180);
	m_forward.z = cos((m_orientation.y) * 3.1415 / 180);
	m_forward.Normalize();


	// an attempt was made to add 3d mouse rotation to camera
	// but it didn't work in time

	/*m_forward.x = cos((m_orientation.x) * 3.1415f / 180.0f) * sin((m_orientation.y) * 3.1415f / 180.0f);	
	m_forward.y = sin((m_orientation.x) * 3.1415f / 180.0f) * sin((m_orientation.y) * 3.1415f / 180.0f);
	m_forward.z = cos((m_orientation.y) * 3.1415f / 180.0f);
	m_forward.Normalize();*/

	// want to keep m_forward.y to be 0 < x < -180
	
	//if (m_forward.y > 180) { m_forward.y = 180; }
	//if (m_forward.y < -180) { m_forward.y = -180; }
